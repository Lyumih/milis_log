...
;
	($.$milis_log_demo) = class $milis_log_demo extends ($.$mol_example_small) {
		Info(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ("# Быстрое логирование функций\n");
			return obj;
		}
		input_value(next){
			if(next !== undefined) return next;
		...
		Input(){
			...
			(obj.value) = (next) => ((this.input_value(next)));
			return obj;
		}
		Input_label(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ("Откройте консоль и начните вводить текст");
		...
		Input_length(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.input_length()));
			return obj;
		}
		Length_label(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ("Реактивно связанное значение - длина строки");
			(obj.content) = () => ([(this.Input_length())]);
			return obj;
		}
		v(next){
			if(next !== undefined) return next;
		...
		T(){
			...
			(obj.value) = (next) => ((this.v(next)));
			return obj;
		}
		Example_label(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ("Пример кода");
			(obj.content) = () => ([(this.T())]);
			return obj;
		}
		Image(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ("![image](https://github.com/user-attachments/assets/4022a849-c1ea-4def-88a5-d80a531659b8)");
			return obj;
		}
		Layout(){
			const obj = new this.$.$mol_list();
	...
	($mol_mem(($.$milis_log_demo.prototype), "Info"));
	($mol_mem(($.$milis_log_demo.prototype), "input_value"));
	($mol_mem(($.$milis_log_demo.prototype), "Input"));
	($mol_mem(($.$milis_log_demo.prototype), "Input_label"));
	($mol_mem(($.$milis_log_demo.prototype), "Input_length"));
	($mol_mem(($.$milis_log_demo.prototype), "Length_label"));
	($mol_mem(($.$milis_log_demo.prototype), "v"));
	($mol_mem(($.$milis_log_demo.prototype), "T"));
	($mol_mem(($.$milis_log_demo.prototype), "Example_label"));
	($mol_mem(($.$milis_log_demo.prototype), "Image"));
	($mol_mem(($.$milis_log_demo.prototype), "Layout"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $milis_log_demo extends $.$milis_log_demo {
            input_value(next) {
                return next || '';
            }
            input_length() {
        ...
        __decorate([
            $milis_log,
            $mol_mem
        ], $milis_log_demo.prototype, "input_value", null);
        __decorate([
            $milis_log
        ], $milis_log_demo.prototype, "input_length", null);
        $$.$milis_log_demo = $milis_log_demo;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
